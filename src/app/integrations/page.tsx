      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[var(--bg-primary)]/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-2 flex items-center justify-between">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={mounted ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6 }} className="flex items-center gap-1.5 sm:gap-4">
            <Link href="/" className="px-2 sm:px-5 py-2.5 text-xs sm:text-sm font-medium text-zinc-300 hover:text-white transition-colors">Home</Link>
            <Link href="/integrations/docs" className="px-2 sm:px-5 py-2.5 text-xs sm:text-sm font-medium text-cyan-400 hover:text-cyan-300 transition-colors">Docs</Link>
